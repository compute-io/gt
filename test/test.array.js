...
describe( 'array gt', function tests() {
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( gt( [], [], 1 ), [] );
		assert.deepEqual( gt( new Int8Array(), new Int8Array(), 1 ), new Int8Array() );
	});
